...
$regionQuery = returnDropDown(returnArray("select DISTINCT region_name from region order by region_name;", $dbconn));
...
if(isset($_SESSION['wines'])){
  $wineDisplay = $_SESSION['wines']. " wines have been viewed in this session."; } 
  else{
    $wineDisplay = "Session not started yet";
    } 
